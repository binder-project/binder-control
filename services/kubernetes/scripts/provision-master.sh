...
EOF
  ...
  curl -sS -L --connect-timeout 20 --retry 6 --retry-delay 10 https://bootstrap.saltstack.com/develop | sh -s -- -M -N
...
if ! which salt-minion >/dev/null 2>&1; then
  ...
  # Install Salt minion
  curl -sS -L --connect-timeout 20 --retry 6 --retry-delay 10 https://bootstrap.saltstack.com/develop | sh -s
